...
public class SSRFTask2 extends AssignmentEndpoint {
  ...
  protected AttackResult furBall(String url) {
    if (url.matches("http://ifconfig\\.pro")) {
      String html;
      try {
        // Use the user-provided URL for validation but the hardcoded URL for the actual request
        // This maintains compatibility with tests while fixing the SSRF vulnerability
