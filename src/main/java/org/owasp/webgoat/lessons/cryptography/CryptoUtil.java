...
public class CryptoUtil {
  ...
  public static String getPrivateKeyInPEM(KeyPair keyPair) {
    String encodedString = PRIVATE_KEY_BEGIN;
    encodedString =
        encodedString
            + new String(
            ...
            + "\n";
    encodedString = encodedString + PRIVATE_KEY_END;
  ...
  public static PrivateKey getPrivateKeyFromPEM(String privateKeyPem)
    ...
    privateKeyPem = privateKeyPem.replace(PRIVATE_KEY_BEGIN.trim(), "");
    privateKeyPem = privateKeyPem.replace(PRIVATE_KEY_END.trim(), "");
