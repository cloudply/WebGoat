...
public class JWTRefreshEndpoint extends AssignmentEndpoint {
  ...
  private Map<String, Object> createNewTokens(String user) {
    ...
    // Use SecureRandom directly with RandomStringUtils
    SecureRandom secureRandom = new SecureRandom();
    char[] possibleCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".toCharArray();
    String refreshToken = RandomStringUtils.random(20, 0, possibleCharacters.length, false, false, possibleCharacters, secureRandom);
  ...
  public ResponseEntity<AttackResult> checkout(
    ...
    try {
      // Keep using parse() here as this is part of the lesson
  ...
  public ResponseEntity newToken(
    ...
    String refreshToken;
    try {
      // Fix the security issue by using parseClaimsJws instead of parse
